...
/*
  ...
  项目参考：
    ...
    * 在线仿真：https://wokwi.com/projects/374367072640791553
    * B站：路徍要什么自行车：https://www.bilibili.com/video/BV1HA411S7pv/
...
void sleep_proc()
{
  while (ui.sleep)
  {
    ...
    if (btn.pressed) { btn.pressed = false;
        ui.index = M_MAIN;  ui.state = S_LAYER_IN; u8g2.setPowerSave(0); ui.sleep = false;
    }
  }
}
